/**
 * M22 / H-S78B evidence I/O — declared docs/plan3 paths only.
...
export const WRITE_EVIDENCE_ENV = 'M22_HS78B_WRITE_EVIDENCE';
...
export function writeHs78bEvidenceJson(repoRoot, relPath, data, opts = {}) {
