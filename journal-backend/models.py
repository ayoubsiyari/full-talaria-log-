...
class Group(db.Model):
    ...
    # Mentorship cohorts: default dashboard modules applied to imported members
    # (JSON object string, e.g. {"backtest": true, "journal": true}).
    default_modules = db.Column(db.Text, nullable=True)
...
class LiveJournalAccount(db.Model):
    ...
    platform = db.Column(db.String(80), nullable=False, default='Manual')
