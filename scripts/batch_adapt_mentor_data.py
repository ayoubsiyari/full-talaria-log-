...
def trade_to_journal_add_payload(trade: dict[str, Any], profile_id: int) -> dict[str, Any]:
    ...
    extra = {
        ...
        "plan_review": trade.get("planReviewKey") or trade.get("planReview"),
        "plan_outcome": trade.get("planOutcome"),
        "plan_behavior": trade.get("plan_behavior") or trade.get("planBehavior"),
        "discipline_status": trade.get("planReviewKey") or trade.get("planReview"),
        "rules_followed": trade.get("rulesFollowed"),
        "missed_trade": bool(trade.get("missedTrade")),
        "demons": trade.get("demons") or [],
        "demon_catcher": trade.get("demonCatcher"),
        "demon_category": trade.get("demon_category"),
