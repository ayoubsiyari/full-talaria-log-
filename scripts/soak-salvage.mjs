...
if (s1.mbPerThousandBars_endpoint != null && s2.mbPerThousandBars_endpoint != null) {
  report.headline = {
    ...
    agreementWithPriorWork: `Segment 1's ${s1.mbPerThousandBars_endpoint} MB/kbar sits against the two independent figures already published: 23.98 (zero-trade monotonic run) and 24.55 (with trades). Three measurements, one number.`,
  };
}
