...
| `w76-growth-attribution-distinct.slim.json` | **P2b** What actually grows, measured in the leaking config: `ExternalStringData` +62.76 MB (62% of growth) retained as **script source** (642 Scripts, 92 MB), plus the whole compile family. `cache-suspect` = 65 bytes |
