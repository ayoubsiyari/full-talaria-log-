...
const MGR = path.join(ROOT, 'chart v 1.4/chart/multichart-prod/multichart-manager.js');
const MGR_MIRROR = path.join(ROOT, 'homepage/public/chart/multichart-prod/multichart-manager.js');
