...
- **Current phase:** 1 (Critical data-loss fixes) — IN PROGRESS
...
| — PHASE 1 GATE — | Manager | 1 | TODO | reports/MANAGER/PHASE1_GATE.md | — | |
| A4 payload budget | A | 2 | TODO | reports/A/A4.md | — | |
| A5 root conditions + tree | A | 2 | TODO | reports/A/A5.md | — | |
| A6 fetch-fail surfacing | A | 2 | TODO | reports/A/A6.md | — | pairs w/ A1 |
| B2 TF cap + case | B | 2 | TODO | reports/B/B2.md | — | ICR-1 |
| B3 instrument grids | B | 2 | TODO | reports/B/B3.md | — | |
| B4 edit restoration | B | 2 | TODO | reports/B/B4.md | — | ICR-2 |
| C2 template overwrite guard | C | 2 | TODO | reports/C/C2.md | — | ICR-3 |
| D2 markets restore (verify) | D | 2 | TODO | reports/D/D2.md | — | ICR-4 |
| — PHASE 2 GATE — | Manager | 2 | TODO | reports/MANAGER/PHASE2_GATE.md | — | |
| A7 name normalization | A | 3 | TODO | reports/A/A7.md | — | D-3 default (a) |
| B5 feedback & caps | B | 3 | TODO | reports/B/B5.md | — | |
| C3 canvas UX batch | C | 3 | TODO | reports/C/C3.md | — | needs D-2 |
| C4 PDF polish | C | 3 | TODO | reports/C/C4.md | — | |
| D3 sort/filter honesty | D | 3 | TODO | reports/D/D3.md | — | |
| D4 dead-code sweep | D | 3 | TODO | reports/D/D4.md | — | |
...
|---|---|---|---|---|
| ICR-1 saveBuilder TF guard | B→A | B2 | NOT OPENED | reports/B/ICR-1.md |
| ICR-2 lifted TF/market state | B→D | B4 | NOT OPENED | reports/B/ICR-2.md |
| ICR-3 hasExistingGroups prop | C→D | C2 | NOT OPENED | reports/C/ICR-3.md |
| ICR-4 openBuilder markets | D→A | D2 | NOT OPENED | reports/D/ICR-4.md |
