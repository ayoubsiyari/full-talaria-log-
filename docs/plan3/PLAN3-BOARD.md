...
- **M1 CANDIDATE — CKPT-019 (supersedes CKPT-018; not yet a milestone claim):** source tag `m1-m19i-20260724b61-source` resolves remotely to `469778e3f182645da6578d1c845ca9dd85599235`; build ID `20260724b61`; chart image `ghcr.io/ayoubsiyari/talaria-trading-chart@sha256:4b05eb06de35797215a218b275103c7e0d726db4a479fe64de3b7b117da31f54`; homepage image `ghcr.io/ayoubsiyari/talaria-homepage@sha256:24ebce3b74e2021a2edb77ae5b1881eef169654357e5fb9379f463b5fc03144f`. Source/proof preflight is GREEN (33 checks), exact-digest image tripwire is GREEN (29 checks), and provenance manifest SHA-256 is `0e465e00ec4848d23ec9af721716054c8e02e3c7be25db73c5b63cb029f4800f`. Adds M19-I-g2 label-coherent tick speed and frame-budgeted forming paints through 100× (kill-switch `__TALARIA_DISABLE_M19I_TICK_SPEED_COHERENCE_V1`). Local real-browser five-MA gate is GREEN at 60×/100× with zero stale/value-mismatch/frozen frames and zero fast-mode ratio; switch OFF is RED at both speeds. M1 remains OPEN until exact-digest test deployment, deployed gates, and PO feel confirmation.
