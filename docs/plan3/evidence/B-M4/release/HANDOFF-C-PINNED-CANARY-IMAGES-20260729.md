...
> **PARTIALLY SUPERSEDED — read `HANDOFF-C-GRADE-LANE-20260729.md` first.**
> The "Bring up a historical pin" and "Restore live floor after grading" sections
> below tell you to `docker compose up` a pin on the **live** project. That is
> what displaced b99 with b85 three times on 2026-07-29 and made the train look
> unshipped. Grade with `canary-grade-lane.sh` instead — it runs the pin as a
> second container on `127.0.0.1:3001` and leaves live alone. The pin inventory
> and the tag/tar/pin-file mechanism below remain correct.
>
> **Live floor is now `20260729b99`**, tip `0affbd697`.
