...
**Renumbered by A at 11:26+01:00 from PSL-38 and PSL-39.** D claimed PSL-38 at 10:41+01:00 and B's BOM row holds PSL-39, both before mine existed. The earlier claim stands and ids are never reused. Mine were written straight onto disk and landed in B's `2da8e2f70` before I could commit them, which is PSL-34 a second time.

### PSL-42 · CENSUS-TREE-01 — the gate census executed inside the tree it was auditing

**Written by A on the Director's ruling, on disk before B's `2da8e2f70` (committed 11:16:28+01:00 /
2026-08-04T10:16Z) swept it in; renumbered by me at 11:26+01:00. This row is a rule, not a proposal, and
the rule is enforced by the instrument rather than by whoever runs it.**
...
### PSL-43 · A mirrored gate with a fixed-depth root writes its evidence into `homepage/`, and exits green
