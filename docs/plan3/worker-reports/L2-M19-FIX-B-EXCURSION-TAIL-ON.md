# L2-M19 — Fix B excursion tail (ON)

**Verdict:** FIX-B-GREEN — M19-PERSIST-RED — Fix-A+B pass 3/3; open excursion ≤ 256; persist bound fail 3/3 (c not in scope)
...
- startedAt (wall): 2026-07-23T00:25:24.600Z
- finishedAt (wall): 2026-07-23T00:25:29.290Z
- elapsedMs: 4549
...
### Canonical repeat 1
- frame first/last median: 0.0326 → 0.0266 (ratio 0.815; limit ≤ 1.25)
- slope/1k: -0.0016 (frac of first -0.0478; limit ≤ 0.05)
...
### Canonical repeat 2
- frame first/last median: 0.0270 → 0.0266 (ratio 0.983; limit ≤ 1.25)
- slope/1k: 0.0000 (frac of first 0.0000; limit ≤ 0.05)
- runtime bytes: 66279 → 67810 (abs limit 262144)
- session bytes: 66318 → 1123730 (abs limit 524288)
- steady growth runtime/session: -15 / 211177
- paths a–e exercised: true
...
### Canonical repeat 3
- frame first/last median: 0.0248 → 0.0254 (ratio 1.026; limit ≤ 1.25)
- slope/1k: 0.0001 (frac of first 0.0032; limit ≤ 0.05)
- runtime bytes: 66279 → 67810 (abs limit 262144)
- session bytes: 66318 → 1123730 (abs limit 524288)
- steady growth runtime/session: -15 / 211177
- paths a–e exercised: true
...
| Cell | Result |
|---|---|
| neighbor-single-playing | ratio=0.992 slopeFrac=-0.039 persistFail=true |
| neighbor-single-paused | ratio=0.522 slopeFrac=-0.064 persistFail=true |
| neighbor-multichart-host+projected-playing | ratio=0.827 slopeFrac=-0.010 persistFail=true |
| neighbor-multichart-host+projected-paused | ratio=1.290 slopeFrac=0.065 persistFail=true |
...
- JSON: `docs\plan3\evidence\L2-M19-fix-b-excursion-tail-on.json`
- Report: `docs\plan3\worker-reports\L2-M19-FIX-B-EXCURSION-TAIL-ON.md`
