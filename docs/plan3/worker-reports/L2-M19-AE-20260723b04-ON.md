...
- startedAt (wall): 2026-07-23T09:54:57.209Z
- finishedAt (wall): 2026-07-23T09:55:02.903Z
- elapsedMs: 5566
...
### Canonical repeat 1
- frame first/last median: 0.0344 → 0.0376 (ratio 1.093; limit ≤ 1.25)
- slope/1k: -0.0012 (frac of first -0.0337; limit ≤ 0.05)
...
### Canonical repeat 2
- frame first/last median: 0.0405 → 0.0272 (ratio 0.670; limit ≤ 1.25)
- slope/1k: -0.0020 (frac of first -0.0481; limit ≤ 0.05)
- runtime bytes: 1886 → 1879 (abs limit 262144)
- session bytes: 1925 → 64623 (abs limit 524288)
- steady growth runtime/session: 3 / 12502
- paths a–e exercised: true
...
### Canonical repeat 3
- frame first/last median: 0.0374 → 0.0266 (ratio 0.711; limit ≤ 1.25)
- slope/1k: -0.0021 (frac of first -0.0551; limit ≤ 0.05)
- runtime bytes: 1886 → 1879 (abs limit 262144)
- session bytes: 1925 → 64623 (abs limit 524288)
- steady growth runtime/session: 3 / 12502
- paths a–e exercised: true
...
| Cell | Result |
|---|---|
| neighbor-single-playing | ratio=1.193 slopeFrac=0.181 persistFail=false |
| neighbor-single-paused | ratio=0.840 slopeFrac=-0.080 persistFail=false |
| neighbor-multichart-host+projected-playing | ratio=1.024 slopeFrac=-0.010 persistFail=false |
| neighbor-multichart-host+projected-paused | ratio=0.904 slopeFrac=-0.077 persistFail=false |
