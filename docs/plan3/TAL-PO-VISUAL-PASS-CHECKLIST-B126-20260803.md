...
Rows 1–18 are **Seal Gate 3**. Rows 19–24 are **Beyond Gate** and must not extend the PO's committed visual-pass window. Rows 25–31 are the PO b122-recipe addendum.
...
## PO b122 Recipe Addendum — Rows 25–31
