    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white p-8">
      ...
      <header className="flex items-center justify-between mb-8">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-cyan-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400"
        >
          <Plus size={16} />
          New Strategy
        </button>
