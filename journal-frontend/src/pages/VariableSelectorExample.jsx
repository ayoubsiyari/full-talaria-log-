  ...
  return (
    <div className="min-h-screen bg-cyan-950/25 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-cyan-950/40 rounded-xl shadow-lg p-8">
          ...
          <div className="bg-cyan-950/25 rounded-lg p-6">
            ...
            {Object.keys(selectedVariables).length === 0 ? (
              ...
              <div className="space-y-3">
                {Object.entries(selectedVariables).map(([varName, values]) => (
                  <div key={varName} className="bg-cyan-950/40 rounded-lg p-4 border">
                    <h4 className="font-medium text-gray-900 capitalize mb-2">{varName}</h4>
                    <div className="flex flex-wrap gap-2">
                      {values.map((value, index) => (
                        <span
                          key={index}
                          className="px-3 py-1 bg-blue-100 text-cyan-100 rounded-full text-sm"
                        >
                          {value}
                        </span>
                      ))}
          ...
          <div className="mt-8 p-4 bg-cyan-950/25 rounded-lg">
