...
const QuickActionCard = ({ icon: Icon, title, description, href, color }) => (
  <a
    href={href}
    className="group flex items-center gap-4 rounded-xl bg-white/[0.03] border border-white/[0.08] hover:border-white/[0.15] hover:bg-white/[0.05] transition-all duration-300 p-4"
  >
      ...
      <div className="min-h-screen bg-[#030014] text-white flex items-center justify-center">
        <div className="text-center">
          <div className="relative w-20 h-20 mx-auto mb-6">
            ...
            <div className="absolute inset-2 border-4 border-blue-500/40 border-t-transparent rounded-full animate-spin"></div>
          </div>
    ...
    return (
      <div className="min-h-screen bg-[#030014] text-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button onClick={() => window.location.reload()} className="px-6 py-2.5 bg-white/10 border border-white/10 text-white text-sm font-medium rounded-lg hover:bg-white/15 transition-all">
            Try Again
          </button>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-[#030014] text-white flex items-center justify-center">
        <div className="text-center max-w-lg mx-auto p-8">
          <div className="w-20 h-20 mx-auto mb-8 bg-blue-500/10 rounded-2xl flex items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/import-trades" className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 transition-all">
              <Upload className="w-4 h-4" /> Import Trades
            </Link>
            <Link to="/journal" className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium text-white/60 bg-white/[0.05] border border-white/[0.08] hover:bg-white/[0.08] transition-all">
    ...
    <div className="min-h-screen bg-[#030014]">
      ...
      <div className="w-full px-6 lg:px-8 py-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
          <QuickActionCard icon={BarChart3} title="Backtesting" description="Practice strategies" href="/backtest" color="bg-blue-600/80" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
            ...
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><TrendingUp className="w-3.5 h-3.5 text-blue-400" /></div>
          ...
          <MetricCard>
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><Target className="w-3.5 h-3.5 text-blue-400" /></div>
          ...
          <MetricCard>
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><Calculator className="w-3.5 h-3.5 text-blue-400" /></div>
          ...
          <MetricCard>
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><Award className="w-3.5 h-3.5 text-blue-400" /></div>
          ...
          <MetricCard>
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><Activity className="w-3.5 h-3.5 text-blue-400" /></div>
          ...
          <MetricCard>
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <div className="p-1.5 rounded bg-blue-500/10"><Shield className="w-3.5 h-3.5 text-blue-400" /></div>
            ...
            <div className="flex items-center justify-between h-full">
              <div className="flex flex-col">
                ...
                <div className="flex space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className={`w-1.5 h-1.5 rounded-full ${i < ({ elite: 5, expert: 4, advanced: 3, intermediate: 2, beginner: 1 }[performanceRating] || 1) ? 'bg-amber-400' : 'bg-white/10'}`}></div>
                  ))}
                </div>
              </div>
            </div>
        ...
        {backtestSessions.length > 0 && (
          <div className="mb-6 rounded-xl bg-white/[0.03] border border-white/[0.08] p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-semibold text-white/70">Recent Backtest Sessions</h3>
              <a href="/backtest" className="text-xs text-blue-400/70 hover:text-blue-400 transition-colors">View all &rarr;</a>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {backtestSessions.map(s => (
                <a
                  ...
                  className="flex items-center gap-3 rounded-lg bg-white/[0.02] border border-white/[0.06] hover:border-white/[0.12] p-3 transition-all group"
                >
        ...
        <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[['area', 'Area'], ['line', 'Line'], ['bar', 'Bar']].map(([val, label]) => (
                <button key={val} onClick={() => setPortfolioChartType(val)} className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${portfolioChartType === val ? 'bg-white/10 text-white border border-white/[0.12]' : 'text-white/30 hover:text-white/60 border border-transparent'}`}>{label}</button>
              ))}
              <select value={showCumulative ? 'cumulative' : 'period'} onChange={e => setShowCumulative(e.target.value === 'cumulative')} className="bg-white/[0.05] border border-white/[0.08] text-white/70 px-3 py-1.5 rounded-lg text-xs">
                <option value="cumulative">Cumulative</option>
                <option value="period">{timePeriod.charAt(0).toUpperCase() + timePeriod.slice(1)}</option>
              </select>
              <select value={timePeriod} onChange={e => setTimePeriod(e.target.value)} className="bg-white/[0.05] border border-white/[0.08] text-white/70 px-3 py-1.5 rounded-lg text-xs">
                    ...
                    <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className="py-3 px-3">
                        {trade.pnl > 0 ? (
                          ...
                          <span className="px-2 py-0.5 rounded text-xs font-bold bg-white/5 text-white/30">BE</span>
                        )}
                      </td>
