...
export default function StrategyStep3({ strategy, updateStrategy }) {
  const handleAddRule = () => {
    const rules = strategy.exitRules || [];
    updateStrategy({ ...strategy, exitRules: [...rules, ''] });
  };
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold mb-4">Exit Rules</h2>
