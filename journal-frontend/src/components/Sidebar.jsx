  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <div className="mb-4">
          {isCollapsed ? (
            <Tooltip content="Main Dashboard" position="right">
              <a href="/dashboard/" className="flex items-center justify-center px-2 py-2 rounded-lg text-cyan-400/60 hover:bg-cyan-500/10 hover:text-cyan-300 transition-all duration-300">
            ...
            <a href="/dashboard/" className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-cyan-400/60 hover:bg-cyan-500/10 hover:text-cyan-300 transition-all duration-300 text-xs font-semibold uppercase tracking-wider border border-cyan-500/15">
