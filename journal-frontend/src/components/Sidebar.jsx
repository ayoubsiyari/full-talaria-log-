...
export default function Sidebar() {
  ...
  return (
    <div 
      className={`${isCollapsed ? 'w-16 shadow-lg' : 'w-64 shadow-xl'} sidebar-gradient border-r border-[#3b82f6]/10 min-h-screen flex flex-col transition-[width] duration-300 ease-in-out`}
    >
      
      {!isCollapsed && (
        <div className="text-center mb-4 pt-6">
          <div className="relative inline-block">
            <div className="w-32 h-32 rounded-full bg-gradient-to-r from-[#3b82f6] to-[#1e3a8a] flex items-center justify-center overflow-hidden shadow-[0_4px_15px_rgba(48,144,255,0.3)]">
              {profileImage ? (
      ...
      {!isCollapsed && (
        <div className="px-4 mb-4 border-b border-[#3b82f6]/10 pb-4">
        ...
        <div className="mt-8 space-y-1">
          ...
          {isCollapsed ? (
            <Tooltip content="Pricing" position="right">
              <NavLink to="/pricing" className={({ isActive }) => `${isActive ? 'bg-gradient-to-r from-[#3b82f6]/20 to-[#1e3a8a]/10 border-l-3 border-[#3b82f6] text-white' : 'text-white/70'} flex items-center justify-center px-2 py-2 rounded-lg hover:bg-[#3b82f6]/10 hover:text-white transition-all duration-300`}>
                <CreditCard className="h-5 w-5" />
              </NavLink>
            </Tooltip>
          ) : (
            <NavLink to="/pricing" className={({ isActive }) => `${isActive ? 'bg-gradient-to-r from-[#3b82f6]/20 to-[#1e3a8a]/10 border-l-3 border-[#3b82f6] text-white' : 'text-white/70'} flex items-center px-3 py-2 rounded-lg hover:bg-[#3b82f6]/10 hover:text-white hover:translate-x-1 transition-all duration-300`}>
              <CreditCard className="h-5 w-5" />
      ...
      <div className={`${isCollapsed ? 'px-2' : 'px-4'} py-6 border-t border-[#3b82f6]/10`}>
        {isCollapsed ? (
