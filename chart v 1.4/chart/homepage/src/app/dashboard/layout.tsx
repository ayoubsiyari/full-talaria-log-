          ...
          <nav className={"flex items-center gap-2 text-sm " + (isArabic ? "flex-row-reverse" : "")}> 
            ...
            {user?.role === "admin" ? (
              <>
                ...
                <a href="/dashboard/admin/datasets/" className="rounded-full border border-white/10 bg-white/5 px-3 py-2 hover:bg-white/10 transition">
                  {nav.adminDatasets}
                </a>
              </>
            ) : null}
