    ...
    buildTextTab(container, drawing, options = {}) {
        ...
        if (!hideVerticalAlign) {
            ...
            const vIcons = isVerticalLine ? [
                ...
                `<line x1="12" y1="4" x2="12" y2="20"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/>`,
            ...
            vAlignSection.innerHTML = `
                ...
                <div class="tv-align-buttons">
                    <button class="tv-align-btn ${currentVAlign === vVal[0] ? 'active' : ''}" data-prop="${vProp}" data-value="${vVal[0]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${vIcons[0]}</svg>
                    </button>
                    <button class="tv-align-btn ${currentVAlign === vVal[1] ? 'active' : ''}" data-prop="${vProp}" data-value="${vVal[1]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${vIcons[1]}</svg>
                    </button>
                    <button class="tv-align-btn ${currentVAlign === vVal[2] ? 'active' : ''}" data-prop="${vProp}" data-value="${vVal[2]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${vIcons[2]}</svg>
                    </button>
                </div>
            `;
            ...
            hAlignSection.innerHTML = `
                ...
                <div class="tv-align-buttons">
                    <button class="tv-align-btn ${currentHAlign === hVal[0] ? 'active' : ''}" data-prop="${hProp}" data-value="${hVal[0]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${hIcons[0]}</svg>
                    </button>
                    <button class="tv-align-btn ${currentHAlign === hVal[1] ? 'active' : ''}" data-prop="${hProp}" data-value="${hVal[1]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${hIcons[1]}</svg>
                    </button>
                    <button class="tv-align-btn ${currentHAlign === hVal[2] ? 'active' : ''}" data-prop="${hProp}" data-value="${hVal[2]}">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${hIcons[2]}</svg>
                    </button>
                </div>
            `;
