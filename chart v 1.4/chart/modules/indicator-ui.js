...
function macdStyleParams() {
    return [
        ...
        { id: 'macdLineWidth', label: 'MACD thickness', type: 'number', default: 2, min: 1, max: 5, tab: 'style' },
        ...
        { id: 'signalLineWidth', label: 'Signal thickness', type: 'number', default: 2, min: 1, max: 5, tab: 'style' },
