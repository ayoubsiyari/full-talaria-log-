...
function __talariaFvgParamList() {
    return [
        { id: 'h1', type: 'heading', label: '1 · Session & Calculation' },
        { id: 'showDayLn', label: 'Daily-open vertical line', type: 'checkbox', default: true },
        { id: 'cDayLn', label: 'Line color', type: 'color', default: 'rgba(128,128,128,0.55)' },
        { id: 'sDayLn', label: 'Line style', type: 'select', options: [{ value: 'solid', label: 'Solid' }, { value: 'dashed', label: 'Dashed' }, { value: 'dotted', label: 'Dotted' }], default: 'dashed' },
        ...
        { id: 'on5', label: '5m gaps — ON / OFF', type: 'checkbox', default: true },
        { id: 'mult5', label: 'Size filter — ATR ×', type: 'number', default: 0, min: 0, step: 0.1 },
        { id: 'cB5f', label: 'Bullish fill (light green)', type: 'color', default: 'rgba(144,238,144,0.28)' },
        { id: 'cR5f', label: 'Bearish fill (light red)', type: 'color', default: 'rgba(255,158,158,0.28)' },
        { id: 'h3', type: 'heading', label: '3 · 15m gaps — entry chart' },
        { id: 'on15', label: '15m gaps — ON / OFF', type: 'checkbox', default: true },
        { id: 'mult15', label: 'Size filter — ATR ×', type: 'number', default: 2, min: 0, step: 0.1 },
        { id: 'first15', label: 'fpFVG tag', type: 'checkbox', default: true },
        { id: 'cF15', label: 'fpFVG fill (orange)', type: 'color', default: 'rgba(255,165,0,0.45)' },
        { id: 'cB15f', label: 'Bullish fill ≥ threshold (dark green)', type: 'color', default: 'rgba(0,110,40,0.32)' },
        { id: 'cR15f', label: 'Bearish fill ≥ threshold (dark red)', type: 'color', default: 'rgba(155,10,10,0.32)' },
        { id: 'h4', type: 'heading', label: '4 · 30m gaps — entry chart' },
        { id: 'on30', label: '30m gaps — ON / OFF', type: 'checkbox', default: true },
        { id: 'mult30', label: 'Size filter — ATR ×', type: 'number', default: 1.5, min: 0, step: 0.1 },
        { id: 'first30', label: 'fpFVG tag', type: 'checkbox', default: true },
        { id: 'cF30', label: 'fpFVG fill (orange)', type: 'color', default: 'rgba(255,165,0,0.50)' },
        { id: 'cB30f', label: 'Bullish fill ≥ threshold (dark green)', type: 'color', default: 'rgba(0,95,35,0.38)' },
        { id: 'cR30f', label: 'Bearish fill ≥ threshold (dark red)', type: 'color', default: 'rgba(140,8,8,0.38)' },
        { id: 'h5', type: 'heading', label: '5 · Mitigation' },
        { id: 'mitBy', label: 'Mitigation measured by', type: 'select', options: [{ value: 'wick', label: 'Wick' }, { value: 'close', label: 'Close' }], default: 'wick' },
        { id: 'mitDepth', label: 'Mitigation level', type: 'select', options: [{ value: 'full fill (100%)', label: 'Full fill (100%)' }, { value: 'midpoint (50%)', label: 'Midpoint (50%)' }], default: 'full fill (100%)' },
        { id: 'hideMit', label: 'Remove filled boxes', type: 'checkbox', default: true },
        { id: 'h6', type: 'heading', label: '6 · Labels & Global' },
        { id: 'txtSizeS', label: 'Tag size', type: 'select', options: [{ value: 'tiny', label: 'Tiny' }, { value: 'small', label: 'Small' }, { value: 'normal', label: 'Normal' }, { value: 'large', label: 'Large' }], default: 'small' },
        { id: 'txtColS', label: 'Tag text color', type: 'select', options: [{ value: 'white', label: 'White' }, { value: 'black', label: 'Black' }], default: 'white' },
        { id: 'padBars', label: 'Tag lane width (bars)', type: 'number', default: 10, min: 3, max: 40 },
        { id: 'showMid', label: 'Show midpoint (CE) line on all gaps', type: 'checkbox', default: false }
    ];
}
...
function __talariaRatioGapParamList() {
    ...
    return [
        { id: 'h1', type: 'heading', label: '1 · Session & Calculation' },
        { id: 'sessStr', label: 'Trading session', type: 'text', default: '09:30-16:00' },
        { id: 'tzStr', label: 'Timezone', type: 'text', default: 'America/New_York' },
        { id: 'avgLen', label: 'Average over N sessions', type: 'number', default: 14, min: 5 },
        { id: 'h2', type: 'heading', label: '2 · Info Box — Style' },
        { id: 'tblPos', label: 'Position', type: 'select', options: tblPos, default: 'bottom_right' },
        { id: 'tblLayout', label: 'Layout', type: 'select', options: [{ value: 'compact (one row)', label: 'Compact (one row)' }, { value: 'headers — horizontal', label: 'Headers — horizontal' }, { value: 'headers — vertical', label: 'Headers — vertical' }], default: 'headers — horizontal' },
        { id: 'txtSize', label: 'Text size', type: 'select', options: [{ value: 'tiny', label: 'Tiny' }, { value: 'small', label: 'Small' }, { value: 'normal', label: 'Normal' }, { value: 'large', label: 'Large' }, { value: 'huge', label: 'Huge' }], default: 'large' },
        { id: 'cTxt', label: 'Text color', type: 'color', default: '#ffffff' },
        { id: 'cellOpacity', label: 'Background opacity %', type: 'number', default: 90, min: 10, max: 100 },
        { id: 'colorOn', label: 'Color cells by regime', type: 'checkbox', default: true },
        { id: 'cNarrow', label: 'Narrow / small', type: 'color', default: '#26a69a' },
        { id: 'cWide', label: 'Wide / large', type: 'color', default: '#ef5350' },
        { id: 'cNeut', label: 'Neutral', type: 'color', default: '#787b86' },
        { id: 'cIn', label: 'Opened IN', type: 'color', default: '#2962ff' },
        { id: 'cOut', label: 'Opened OUT', type: 'color', default: '#ff9800' },
        { id: 'h3', type: 'heading', label: "3 · PDR — Previous Day's Range" },
        { id: 'showPDR', label: 'PDR — ON / OFF', type: 'checkbox', default: true },
        { id: 'pdrLines', label: 'Show PDH / PDL / MID lines', type: 'checkbox', default: true },
        { id: 'pdrCell', label: 'Show RANGE cell in info box', type: 'checkbox', default: true },
        { id: 'pdrIOCell', label: 'Show IN/OUT cell in info box', type: 'checkbox', default: true },
        { id: 'showPDRTg', label: 'Show ±0.3× / ±0.5× targets (inside-bar days)', type: 'checkbox', default: false },
        { id: 'showDead', label: 'Show compass dead-zone box', type: 'checkbox', default: true },
        { id: 'deadPct', label: 'Dead-zone width (% of range, centered)', type: 'number', default: 10, min: 1, max: 40, step: 1 },
        { id: 'rngNarrow', label: 'RANGE — narrow ≤', type: 'number', default: 0.6, step: 0.05 },
        { id: 'rngWide', label: 'RANGE — wide ≥', type: 'number', default: 1.3, step: 0.05 },
        { id: 'cPDHi', label: 'PDH color', type: 'color', default: '#008080' },
        { id: 'sPDHi', label: 'PDH style', type: 'select', options: lineStyle, default: 'solid' },
        { id: 'cPDLi', label: 'PDL color', type: 'color', default: '#008080' },
        { id: 'sPDLi', label: 'PDL style', type: 'select', options: lineStyle, default: 'solid' },
        { id: 'cMidi', label: 'Midpoint color', type: 'color', default: '#787b86' },
        { id: 'sMidi', label: 'Midpoint style', type: 'select', options: lineStyle, default: 'dotted' },
        { id: 'cPTgi', label: 'Targets color', type: 'color', default: '#ff00ff' },
        { id: 'sPTgi', label: 'Targets style', type: 'select', options: lineStyle, default: 'dotted' },
        { id: 'cDeadi', label: 'Dead-zone fill', type: 'color', default: 'rgba(128,128,128,0.12)' },
        { id: 'wPrev', label: 'Line width', type: 'number', default: 1, min: 1, max: 4 },
        { id: 'h4', type: 'heading', label: '4 · GAP — Opening Gap' },
        { id: 'showGapSect', label: 'GAP — ON / OFF', type: 'checkbox', default: true },
        { id: 'gapLines', label: 'Show Y-CLOSE / GAP-50% lines', type: 'checkbox', default: true },
        { id: 'gapCell', label: 'Show GAP cell in info box', type: 'checkbox', default: true },
        { id: 'showOpen', label: "Show today OPEN line", type: 'checkbox', default: true },
        { id: 'gapSmall', label: 'GAP — small ≤', type: 'number', default: 0.25, step: 0.05 },
        { id: 'gapLarge', label: 'GAP — large ≥', type: 'number', default: 0.75, step: 0.05 },
        { id: 'cPCi', label: 'Y-close color', type: 'color', default: '#ff9800' },
        { id: 'sPCi', label: 'Y-close style', type: 'select', options: lineStyle, default: 'dashed' },
        { id: 'cG50i', label: 'Gap 50% color', type: 'color', default: '#ff9800' },
        { id: 'sG50i', label: 'Gap 50% style', type: 'select', options: lineStyle, default: 'dotted' },
        { id: 'cOPi', label: 'Today open color', type: 'color', default: '#00ffff' },
        { id: 'sOPi', label: 'Today open style', type: 'select', options: lineStyle, default: 'solid' },
        { id: 'wGap', label: 'Line width', type: 'number', default: 1, min: 1, max: 4 },
        { id: 'h5', type: 'heading', label: '5 · ORB-15 — Opening Range' },
        { id: 'showOR', label: 'ORB-15 — ON / OFF', type: 'checkbox', default: true },
        { id: 'orLines', label: 'Show OR-H / OR-L lines', type: 'checkbox', default: true },
        { id: 'orCell', label: 'Show OR cell in info box', type: 'checkbox', default: true },
        { id: 'showORTg', label: 'Show ±0.3× / ±0.5× targets', type: 'checkbox', default: false },
        { id: 'orNarrow', label: 'OR — narrow ≤', type: 'number', default: 0.20, step: 0.05 },
        { id: 'orWide', label: 'OR — wide ≥', type: 'number', default: 0.55, step: 0.05 },
        { id: 'cORi', label: 'OR high/low color', type: 'color', default: '#2962ff' },
        { id: 'sORi', label: 'OR style', type: 'select', options: lineStyle, default: 'solid' },
        { id: 'cOTgi', label: 'OR targets color', type: 'color', default: '#9c27b0' },
        { id: 'sOTgi', label: 'OR targets style', type: 'select', options: lineStyle, default: 'dotted' },
        { id: 'wOR', label: 'Line width', type: 'number', default: 1, min: 1, max: 4 },
        { id: 'orStr', label: 'ORB window (advanced)', type: 'text', default: '09:30-09:45' },
        { id: 'h6', type: 'heading', label: '6 · IB-60 — Initial Balance' },
        { id: 'showIB', label: 'IB-60 — ON / OFF', type: 'checkbox', default: false },
        { id: 'ibLines', label: 'Show IB-H / IB-L lines', type: 'checkbox', default: true },
        { id: 'ibCell', label: 'Show IB cell in info box', type: 'checkbox', default: true },
        { id: 'showIBTg', label: 'Show ±0.3× / ±0.5× targets', type: 'checkbox', default: false },
        { id: 'ibNarrow', label: 'IB — narrow ≤', type: 'number', default: 0.30, step: 0.05 },
        { id: 'ibWide', label: 'IB — wide ≥', type: 'number', default: 0.80, step: 0.05 },
        { id: 'cIBi', label: 'IB high/low color', type: 'color', default: '#000080' },
        { id: 'sIBi', label: 'IB style', type: 'select', options: lineStyle, default: 'dashed' },
        { id: 'cTgti', label: 'IB targets color', type: 'color', default: '#9c27b0' },
        { id: 'sTgti', label: 'IB targets style', type: 'select', options: lineStyle, default: 'dotted' },
        { id: 'wIB', label: 'Line width', type: 'number', default: 1, min: 1, max: 4 },
        { id: 'ibStr', label: 'IB window (advanced)', type: 'text', default: '09:30-10:30' },
        { id: 'h7', type: 'heading', label: '7 · Labels & Global' },
        { id: 'showLbl', label: 'Show level labels', type: 'checkbox', default: true },
        { id: 'lblSizeS', label: 'Label size', type: 'select', options: [{ value: 'tiny', label: 'Tiny' }, { value: 'small', label: 'Small' }, { value: 'normal', label: 'Normal' }, { value: 'large', label: 'Large' }, { value: 'huge', label: 'Huge' }], default: 'normal' },
        { id: 'lblOff', label: 'Label offset (bars →)', type: 'number', default: 2, min: 0, max: 20 },
        { id: 'mergeK', label: 'Stagger labels closer than (× avg range)', type: 'number', default: 0.05, min: 0, step: 0.01 },
        { id: 'lblStagger', label: 'Stagger spacing (bars)', type: 'number', default: 10, min: 2, max: 40 },
        { id: 'keepSess', label: "Keep past sessions' levels (0 = today only)", type: 'number', default: 0, min: 0, max: 25 },
        { id: 'lvlOpacity', label: 'All lines opacity %', type: 'number', default: 100, min: 10, max: 100 }
    ];
}
