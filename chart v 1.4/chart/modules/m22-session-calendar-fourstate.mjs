...
const STATES = [
    { state: 'broken', expect: 'fail', why: 'real product as committed — the defect must be caught' },
    { state: 'fixed', expect: 'pass', why: 'product + WIRING_PATCH — the oracle must be satisfiable' },
