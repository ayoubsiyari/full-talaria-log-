...
<body style="font-family:Arial,sans-serif;color:#111827;padding:20px;">
    ...
    createOrderPanel() {
        ...
        if (_existingStyle) _existingStyle.remove();
        {
            ...
            styleEl.textContent = `
                ...
                /* ── Submit (green / red fill + tinted label text) ── */
                ...
                .order-submit-btn {
                    ...
                    cursor: pointer;
                    transition: background 0.15s ease, color 0.15s ease, filter 0.15s;
                    box-shadow: none;
                    margin-top: 2px;
                }
    ...
    populateOrderPanelForPendingOrder(order) {
        ...
        if (buyTab && sellTab && placeBtn) {
            ...
            placeBtn.style.background = isBuy ? '#15803d' : '#b91c1c';
            placeBtn.style.color = isBuy ? '#bbf7d0' : '#fecaca';
            placeBtn.style.setProperty('-webkit-text-fill-color', isBuy ? '#bbf7d0' : '#fecaca');
        }
