...
const chartOrderManagerPath = path.resolve(findRoot(__dirname), 'chart v 1.4/chart/modules/order-manager.js');
const homeOrderManagerPath = path.resolve(findRoot(__dirname), 'homepage/public/chart/modules/order-manager.js');
