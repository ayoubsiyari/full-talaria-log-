...
const MGR = path.join(ROOT, 'chart v 1.4/chart/modules/drawing-tools-manager.js');
const MGR_MIRROR = path.join(ROOT, 'homepage/public/chart/modules/drawing-tools-manager.js');
