...
/** Hide Entry+/TP+ split controls on chart, pending/open lines, preview, native order panel, and V9 rail. Set to false to re-enable. */
if (typeof window.__CHART_ENV.DISABLE_ORDER_ENTRY_PLUS_UI === 'undefined') {
    window.__CHART_ENV.DISABLE_ORDER_ENTRY_PLUS_UI = true;
}
