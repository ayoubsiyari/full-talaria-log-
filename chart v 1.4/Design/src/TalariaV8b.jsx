...
const TalariaV8b = () => {
  ...
  const queryWantsNewSession = query.get("newSession") === "1";
  const isModalOnlyNewSession = queryWantsNewSession && query.get("modalOnly") === "1";
  ...
  useEffect(() => {
    ...
    if (queryWantsNewSession) {
      setSessView("sessions");
      setNewSessOpen(true);
      setNewSessAutoOpened(true);
    }
  }, [queryWantsNewSession, newSessAutoOpened]);
